  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content={`https://revista.rendezvouscorp.com${Portada.src}`}
        />
        ...
        <meta
          ...
          content="https://revista.rendezvouscorp.com"
        />
      ...
      <main className="flex items-center justify-center bg-white bg-cover bg-fixed md:bg-logo-pattern">
        {!load ? (
          <div className="flex w-full flex-col gap-0 bg-transparent md:w-[75%]">
            {/* Portada */}
            <div>
              <Image
                src={Portada.src}
            ...
            <div className="my-2 bg-white shadow-xl">
              ...
              <div>
                ...
                <Image
                  ...
                  width={width}
                  height={Height}
                  className="mt-[-5%] w-full shadow-xl"
                  alt="Tinta de Oro"
                />
              </div>
            </div>
